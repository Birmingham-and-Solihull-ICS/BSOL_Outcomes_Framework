...
/*
   Program : REQ3273_20602_FingertipsData.sql 
 ...
 PURPOSE : This .SQL program is used to extract all available data on fingertips for the following 
    ...
    Note :  1. The value of the 20602 indicator on fingertips is a "crude rate" (ie 'crude rate per 100', a percentage).
            ...
            2. The data has been extracted from the fingertips website by running the following API :-
                                 ...
                                 https://fingertips.phe.org.uk/api/all_data/csv/for_one_indicator?indicator_id=20602


            3. This sql script creates the following csv data file :-

                 S:\Intelligence\2. Requests\REQ3273 - Indicator development group with BSOL ICB\REQ3273_20602_FingertipData.csv
...
DECLARE @strAPICall VARCHAR(8000)             
  SET @strAPICall = CHAR(34) + 'https://fingertips.phe.org.uk/api/all_data/csv/for_one_indicator?indicator_id=20602' + CHAR(34)
...
/* Step 6 : Write our data to a *.csv file called "REQ3273_20602_FingertipsData.csv".
            ...
            Investigated the following options :-
                                                 ...
                                                 (a) bcp    - The "bcp" routine does not require the csv file to exist beforehand and any file created is automatically overwritten,
                                                              ...
                                                              Note, using the MS-DOS command prompt the following bcp commands work but as mentioned above no header row can be written :- 
                                                                ...
                                                                bcp PH_Requests.dbo.tblTemp5 out "\\Redacted\test\test2\REQ3273_20602_FingertipsData.csv" -n -c -t, -T -S "SVWVSQ016\SVWVSQ016"
...
/* Step 6a : Write our data to a .csv file called "REQ3273_20602_FingertipsData.csv" using the OpenDataSource() function.
...
DECLARE @strPathFileName VARCHAR(8000)
  SET @strPathFileName = CHAR(39) + '\\Redacted\Intelligence\2. Requests\REQ3273 - Indicator development group with BSOL ICB\REQ3273_20602_FingertipsData.csv' + CHAR(39)
...
-- Important Note :- These sql commands only work if the 'REQ3273_20602_FingertipsData.csv' file already exists with a header
INSERT INTO OPENDATASOURCE('Microsoft.ACE.OLEDB.16.0','Data Source=\\Redacted\Intelligence\2. Requests\REQ3273 - Indicator development group with BSOL ICB; Extended Properties=Text')...[REQ3273_20602_FingertipsData#csv]
SELECT T1.[ValueID],        
       T1.[IndicatorID],
       T1.[InsertDate],
       T1.[Numerator],
  ...
  SELECT T1.[ValueID],
    ...
    FROM OPENDATASOURCE('Microsoft.ACE.OLEDB.16.0',
                        'Data Source=\\Redacted\Intelligence\2. Requests\REQ3273 - Indicator development group with BSOL ICB;
                         Extended Properties=Text')...[REQ3273_20602_FingertipsData#csv] T1   
