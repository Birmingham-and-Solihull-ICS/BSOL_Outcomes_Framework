########################################################################################################
#
# Program : REQ3273_20601_LocalData.R
#
# 26-04-2024
#
#    
...
#            for the fingertips indicator '20601 : Reception prevalence of overweight (including obesity)'.
# 
#
#
...
#
#                 S:\Intelligence\2. Requests\REQ3273 - Indicator development group with BSOL ICB\REQ3273_20601_LocalData.csv
#
...
########################################################################################################
#
# Step 9 : Write our dataframe to a .csv file called "REQ3273_20601_LocalData.csv".
#
#          Table : df_tblTemp10
#
#
...
utils::write.table(x    = df_tblTemp10, 
                  file = "//Redacted/Intelligence/2. Requests/REQ3273 - Indicator development group with BSOL ICB/REQ3273_20601_LocalData.csv",
                  sep=",",
  ...
  SELECT T1.[ValueID],
    ...
    FROM OPENDATASOURCE('Microsoft.ACE.OLEDB.16.0',
                        'Data Source=\\Redacted\Intelligence\2. Requests\REQ3273 - Indicator development group with BSOL ICB;
                         Extended Properties=Text')...[REQ3273_20601_LocalData#csv] T1   
